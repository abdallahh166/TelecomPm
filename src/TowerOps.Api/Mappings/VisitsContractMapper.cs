...
using System.IO;
using TowerOps.Api.Contracts.Visits;
using TowerOps.Application.Commands.Visits.AddChecklistItem;
using TowerOps.Application.Commands.Visits.AddIssue;
using TowerOps.Application.Commands.Visits.AddPhoto;
using TowerOps.Application.Commands.Visits.AddReading;
using TowerOps.Application.Commands.Visits.ApproveVisit;
using TowerOps.Application.Commands.Visits.CancelVisit;
using TowerOps.Application.Commands.Signatures.CaptureVisitSignature;
using TowerOps.Application.Commands.Visits.CheckInVisit;
using TowerOps.Application.Commands.Visits.CheckOutVisit;
using TowerOps.Application.Commands.Visits.CompleteVisit;
using TowerOps.Application.Commands.Visits.CreateVisit;
using TowerOps.Application.Commands.Imports.ImportAlarmCapture;
using TowerOps.Application.Commands.Imports.ImportPanoramaEvidence;
using TowerOps.Application.Commands.Imports.ImportUnusedAssets;
using TowerOps.Application.Commands.Visits.RejectVisit;
using TowerOps.Application.Commands.Visits.RemovePhoto;
using TowerOps.Application.Commands.Visits.RequestCorrection;
using TowerOps.Application.Commands.Visits.RescheduleVisit;
using TowerOps.Application.Commands.Visits.ResolveIssue;
using TowerOps.Application.Commands.Visits.StartVisit;
using TowerOps.Application.Commands.Visits.SubmitVisit;
using TowerOps.Application.Commands.Visits.UpdateChecklistItem;
using TowerOps.Application.Commands.Visits.UpdateReading;
using TowerOps.Application.Queries.Visits.GetEngineerVisits;
using TowerOps.Application.Queries.Visits.GetPendingReviews;
using TowerOps.Application.Queries.Visits.GetScheduledVisits;
using TowerOps.Application.Queries.Visits.GetVisitById;
using TowerOps.Application.Queries.Visits.GetVisitEvidenceStatus;
using TowerOps.Application.Queries.Signatures.GetVisitSignature;
