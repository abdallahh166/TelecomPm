...
using TowerOps.Api.Contracts.Materials;
using TowerOps.Application.Commands.Materials.ConsumeMaterial;
using TowerOps.Application.Commands.Materials.CreateMaterial;
using TowerOps.Application.Commands.Materials.DeleteMaterial;
using TowerOps.Application.Commands.Materials.ReserveMaterial;
using TowerOps.Application.Commands.Materials.RestockMaterial;
using TowerOps.Application.Commands.Materials.UpdateMaterial;
using TowerOps.Application.Queries.Materials.GetMaterialById;
using TowerOps.Application.Queries.Materials.GetMaterialsByOffice;
using TowerOps.Application.Queries.Materials.GetLowStockMaterials;
